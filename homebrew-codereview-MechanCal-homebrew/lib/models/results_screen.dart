...
class _ResultsState extends State<Results> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: BackButton(color: Color.fromRGBO(76, 116, 139, 1)),
        title: Text(""),
          ...
          children: [
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "${gramsOfCoffee}g - $grindSize ground coffee",
                      style: TextStyle(fontSize: 16, letterSpacing: 2),
                    ),
                    Text("${gramsOfWater}g - water",
                        style: TextStyle(fontSize: 16, letterSpacing: 2)),
                    Padding(
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                onPrimary: Color.fromRGBO(76, 116, 139, 1),
              ),
              onPressed: () {
